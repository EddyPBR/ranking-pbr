...
export function GoogleLoginButton() {
  ...
  return (
    <button onClick={handleSignAndCreateRoom} className="bg-red-500 text-white h-12 font-sans rounded hover:bg-red-600 transition-colors font-bold flex items-center px-8 mb-12">
