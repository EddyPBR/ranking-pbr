    ...
    <>
      ...
      <main className="w-full h-screen flex">
        <article className="w-8/12 h-full bg-indigo-600 flex flex-col justify-center">
          <h1 className="font-cursive text-5xl text-gray-50 mb-2 text-center">
            Welcome to Ranking PBR
          </h1>
          <p className="font-sans text-xl text-gray-100 text-center mb-12">
        ...
        <article className="w-4/12 h-full flex flex-col justify-center bg-gray-50 px-32">
          ...
          />
          <button className="bg-indigo-600 text-white h-12 font-sans rounded hover:bg-indigo-700 transition-colors">
            Entrar na sala
          </button>
        </article>
      </main>
